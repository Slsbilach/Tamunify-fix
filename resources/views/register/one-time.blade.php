...
<x-guest-layout>
   <div class="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
    ...
    <div>
        ...
        <x-input.select-input id="purpose" class="mt-1 w-full" name="purpose" required autocomplete="purpose">
    ...
    <div>
        ...
        <x-input.select-input id="department" class="mt-1 w-full" name="department" required autocomplete="department">
    ...
    <!-- Foto Diri -->
    <div class="col-span-1 sm:col-span-2 lg:col-span-3 space-y-2">
