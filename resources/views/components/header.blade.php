      ...
      <div class="flex-shrink-0">
        <a href="{{ url('/') }}">
          <div class="relative h-12 w-52 ml-0">
            <img
              src="{{ asset('assets/images/tamunify-logo.png') }}"
              alt="Tamunify Logo"
  ...
  <div class="relative w-full overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
      <svg viewBox="0 0 1200 120" preserveAspectRatio="none" class="absolute bottom-0 left-0 w-full h-14">
        <path
          d="M0,0 C150,90 350,0 500,100 C650,190 750,100 900,50 C1050,0 1150,80 1200,80 L1200,120 L0,120 Z"
    ...
    <div class="relative z-10 w-full flex items-center justify-between px-4 py-3">
      <a href="{{ url('/') }}" class="flex items-center">
        <div class="relative h-12 w-52">
          <img src="{{ asset('assets/images/bumn-pupuk-logos.png') }}" alt="BUMN and Pupuk Indonesia Logos" class="object-contain w-full h-full" />
        </div>
      </a>
